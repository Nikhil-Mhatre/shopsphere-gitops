{{/*
------------------------------------------------------------------------------
IAM Helm Chart Helper Templates
------------------------------------------------------------------------------

This file contains reusable helper templates used throughout the IAM Helm
chart.
...
helm install identity-service ./charts/iam
